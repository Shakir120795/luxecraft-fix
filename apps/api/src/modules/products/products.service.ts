  ...
  async create(dto: CreateProductDto, adminId: string): Promise<Product> {
    ...
    const product = await this.prisma.product.create({
      data: {
        ...
        returnsInfo: dto.returnsInfo,
        careInstructions: dto.careInstructions,
        origin: dto.origin,
        productNote: dto.productNote,
  ...
  async update(
    ...
    const updated = await this.prisma.product.update({
      ...
      data: {
        ...
        ...(dto.deliveryInfo !== undefined && { deliveryInfo: dto.deliveryInfo }),
        ...(dto.shippingInfo !== undefined && { shippingInfo: dto.shippingInfo }),
        ...(dto.returnsInfo !== undefined && { returnsInfo: dto.returnsInfo }),
        ...(dto.careInstructions !== undefined && { careInstructions: dto.careInstructions }),
        ...(dto.origin !== undefined && { origin: dto.origin }),
        ...(dto.productNote !== undefined && { productNote: dto.productNote }),
