        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
          ...
          <div>
            ...
            <div className="flex gap-4 mb-10">
              ...
              <button className="border border-luxury-sand bg-luxury-beige px-6 py-5 transition-colors hover:border-luxury-gold" aria-label="Save to wishlist">
